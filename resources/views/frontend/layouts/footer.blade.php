            ...
            <div class="col-sm-4">
                <div class="footer-box">
                    ...
                    <div class="box-item wow fadeIn" data-wow-duration="2s">
                        <div class="img-thumb">
                            <a href="#" rel="bookmark"><img class="entry-thumb" src="{{ asset('frontend/images/popular_news_01.jpg') }}" alt="" height="80" width="100"></a>
                        </div>
                    ...
                    <div class="box-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                        <div class="img-thumb">
                            <a href="#" rel="bookmark"><img class="entry-thumb" src="{{ asset('frontend/images/popular_news_02.jpg') }}" alt="" height="80" width="100"></a>
                        </div>
                        <div class="item-details">
                    ...
                    <div class="box-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
                        <div class="img-thumb">
                            <a href="#" rel="bookmark"><img class="entry-thumb" src="{{ asset('frontend/images/popular_news_03.jpg') }}" alt="" height="80" width="100"></a>
                        </div>
                        <div class="item-details">
